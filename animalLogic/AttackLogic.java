		...
		for (Cell cell2 : cellList)
			for (Cell cell: cellList){
				...
				if (cell.getPos().equals(cell2.getPos()) && cell.getNutrientsInSystem() > cell2.getNutrientsInSystem()) {  				 
					...
					evolutionLogic.EvolveGenetic(cell.getLastFiredSequence(), cell.getBaseCellGenetics(), cell);
					deadCells.add(cell2);
					...
					evolutionLogic.EvolveGenetic(cell2.getLastFiredSequence(), cell2.getBaseCellGenetics(), cell2);
					deadCells.add(cell);
				}
