...
import animalObjects.Predator;


public class PopulatePredators {
	
	private ArrayList<Cell> cellList = new ArrayList<>();
	
	public PopulatePredators(int NUM_CELLS, int COLUMNS, int ROWS) {
		...
		for (int i = 0; i < NUM_CELLS; i++) {
			...
			cellList.add(new Predator(nuteX, nuteY, i));
		}
