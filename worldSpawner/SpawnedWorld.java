...
import animalLogic.AttackLogic;
import animalLogic.Cell;
import animalLogic.CellGeneticTranslator;
import animalLogic.PopulatePredators;
...
public class SpawnedWorld extends JPanel implements ActionListener {
	...
	private static ArrayList<Cell> cellList = new PopulatePredators(LaunchWorld.NUM_CELLS,LaunchWorld.COLUMNS,LaunchWorld.ROWS).getCellList();
